...
class AppRoutes {
  static List<GetPage> pages = [
    ...
    GetPage(name: SpecialistDetailScreen.routeName, page: () => const SpecialistDetailScreen()),
    GetPage(
        name: SpecialistDetailScreen.routeName,
        page: () => const SpecialistDetailScreen()),
    GetPage(name: ProfileScreen.routeName, page: () => const ProfileScreen(),),
    GetPage(name: UserInfoScreen.routeName, page: () => const UserInfoScreen(),),
    GetPage(name: PaymentManagementScreen.routeName, page: () => const PaymentManagementScreen(),),
    ...
    GetPage(name: HowToBePartnerScreen.routeName, page: () => const HowToBePartnerScreen(),),
    GetPage(name: PrescriptionScreen.routeName, page: () => const PrescriptionScreen(),),
    GetPage(name: SpecialistScreen.routeName, page: () => const SpecialistScreen()),
